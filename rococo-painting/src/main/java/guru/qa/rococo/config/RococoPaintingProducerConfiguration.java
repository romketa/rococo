...
@Configuration
public class RococoPaintingProducerConfiguration {

  private final KafkaProperties kafkaProperties;

  @Autowired
  public RococoPaintingProducerConfiguration(KafkaProperties kafkaProperties) {
  ...
  public NewTopic topic() {
    return TopicBuilder.name("paintings")
        .partitions(10)
        .replicas(1)
        .build();
  }
